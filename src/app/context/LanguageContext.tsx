...
const PA: Translations = {
  ...
  hiw_step2_desc: 'ਸਾਡਾ ਸਿਸਟਮ ਤੁਰੰਤ 500+ ਯੋਜਨਾਵਾਂ ਸਕੈਨ ਕਰਦਾ ਹੈ।',
...
const KN: Translations = {
  ...
  hiw_step2_desc: 'ನಮ್ಮ ವ್ಯವಸ್ಥೆ ತಕ್ಷಣ 500+ ಯೋಜನೆಗಳನ್ನು ಸ್ಕ್ಯಾನ್ ಮಾಡುತ್ತದೆ.',
...
const GU: Translations = {
  ...
  hiw_step2_desc: 'અમારી સિસ્ટમ તત્કાળ 500+ યોજનાઓ સ્કૅન કરે છે.',
...
const OR: Translations = {
  ...
  hiw_step2_desc: 'ଆମ ସିଷ୍ଟମ ଶୀଘ୍ର 500+ ଯୋଜନା ସ୍କ୍ୟାନ କରେ।',
...
const ML: Translations = {
  ...
  hiw_step2_desc: 'ഞങ്ങളുടെ സിസ്റ്റം 500+ പദ്ധതികൾ ഉടനടി സ്കാൻ ചെയ്യുന്നു.',
...
const AS: Translations = {
  ...
  hiw_step2_desc: 'আমাৰ ছিষ্টেমে তৎক্ষণাৎ 500+ আঁচনি স্কেন কৰে।',
...
const UR: Translations = {
  ...
  hiw_step2_desc: 'ہمارا نظام فوری طور پر 500+ اسکیمیں اسکین کرتا ہے۔',
